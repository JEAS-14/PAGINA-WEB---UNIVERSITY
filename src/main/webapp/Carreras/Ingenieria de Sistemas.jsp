...
<html lang="es">
    ...
    <body>
            ...
            <div id="miCarrusel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="imgUni/IG1.jpg" class="d-block w-100" alt="Campus 1" style="height: 500px; object-fit: cover;">
                    </div>
                    <div class="carousel-item">
                        <img src="imgUni/IG2.jpg" class="d-block w-100" alt="Campus 2" style="height: 500px; object-fit: cover;">
                    </div>
                </div>
        ...
        <div style="background-color: darkred; color: white; font-size: 50px; font-family: 'Arial Black', sans-serif; padding: 30px;">
            <p style="margin-left: 50px;">INGENIERÍA DE SISTEMAS</p>
        </div>
        ...
        <div style="max-width: 1000px; margin: 40px auto; padding: 0 60px; font-size: 18px; line-height: 1.7;">
            <p>
                La carrera de Ingeniería de Sistemas de UGIC forma profesionales capaces de diseñar, desarrollar e implementar soluciones tecnológicas que optimicen los procesos en organizaciones públicas y privadas. Se combina una sólida formación técnica con conocimientos en gestión, innovación y ética profesional.
            </p>

            <ul style="margin-top: 30px;">
                <li><strong>Grado Académico:</strong> Bachiller en Ingeniería de Sistemas</li>
                <li><strong>Título Profesional:</strong> Ingeniero(a) de Sistemas</li>
