                ...
                <div class="card card_login shadow col-12 col-md-8 col-lg-6 mx-auto">
                    ...
                    <div class="card-body">
                        <form action="../AlumnoController" method="post">
                            ...
                            <div class="mb-3">
                                <label for="apellido" class="form-label"><i class="fas fa-user-tag me-1"></i>Apellido:</label>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="idCarrera" name="idCarrera" class="form-select" required>
                                    ...
                                    <%
                                        // Instantiate CarreraDao to get the list of careers
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="rol" name="rol" class="form-control" required placeholder="Ej: alumno">
                            </div>
                            ...
                            <div class="d-flex justify-content-end mt-4">
                                <a href="listado.jsp" class="btn btn-danger me-2">
