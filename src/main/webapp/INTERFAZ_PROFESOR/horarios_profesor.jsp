                ...
                <div class="d-flex align-items-center">
                    <div class="me-3 dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notificationsDropdown">
                            <li><a class="dropdown-item" href="solicitudes_profesor.jsp">Tienes <%= totalPendingJoinRequests %> sol. de unión pendientes</a></li>
                            <li><a class="dropdown-item" href="solicitudes_profesor.jsp">Tienes <%= totalPendingLeaveRequests %> sol. de salida pendientes</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="solicitudes_profesor.jsp">Gestionar Solicitudes</a></li>
                        </ul>
                    </div>
                    <div class="me-3 dropdown">
