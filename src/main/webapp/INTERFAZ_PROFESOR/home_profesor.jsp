...
<head>
    ...
    <style>
        ...
        .stat-card.sales .icon-wrapper { background-color: var(--admin-info); }
        .stat-card.earnings .icon-wrapper { background-color: var(--admin-success); }
        .stat-card.students .icon-wrapper { background-color: var(--admin-warning); }
