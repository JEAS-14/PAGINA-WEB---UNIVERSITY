    ...
    try {
        ...
        if ("unirse".equals(action)) {
            ...
            if (idCurso != null && idProfesor > 0) {
                ...
                String sqlCheck = "SELECT COUNT(*) as total FROM profesor_curso WHERE id_profesor = ? AND id_curso = ?";
                ...
                if (!yaInscrito) {
                    String sql = "INSERT INTO profesor_curso (id_profesor, id_curso, fecha_asignacion) VALUES (?, ?, NOW())";
                    pstmt = conn.prepareStatement(sql);
                    pstmt.setInt(1, idProfesor);
                    pstmt.setInt(2, Integer.parseInt(idCurso));
        ...
        if ("salir".equals(action)) {
            ...
            if (idCurso != null && idProfesor > 0) {
                ...
                int result = pstmt.executeUpdate();
                if (result > 0) {
                    mensaje = "Has salido del curso exitosamente";
                    tipoMensaje = "success";
                } else {
                    mensaje = "Error al salir del curso";
                    tipoMensaje = "danger";
                }
            }
        }
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="main-content">
                ...
                <!-- Tabs para mis cursos y cursos disponibles -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div style="margin-top: 1rem;">
                                            <a href="?action=salir&id_curso=<%= idCurso%>" 
                                               ...
                                               onclick="return confirm('¿Estás seguro de salir del curso: <%= nombreCurso%>?')">
                                                Salir del Curso
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 1.5rem; margin-top: 1.5rem;">
                                <%
                                    try {
                                        ...
                                        // Consulta corregida: une las tablas para obtener solo cursos de la misma facultad del profesor
                                        String sql = "SELECT c.id_curso, c.nombre_curso, c.codigo_curso, c.creditos, "
