...
<head>
    ...
    <style>
        ...
        .stat-card.courses .value { color: var(--admin-info); } /* Info blue */
        .stat-card.courses .icon-wrapper { color: var(--admin-info); }
        .stat-card.active-classes .value { color: var(--admin-success); } /* Success green */
        .stat-card.active-classes .icon-wrapper { color: var(--admin-success); }
        .stat-card.pending-payments .value { color: var(--admin-warning); } /* Warning yellow */
        .stat-card.pending-payments .icon-wrapper { color: var(--admin-warning); }
        .stat-card.student-status .value { color: var(--admin-text-dark); } /* Dark text */
        .stat-card.student-status .icon-wrapper { color: var(--admin-text-dark); }
        ...
        @media (max-width: 768px) {
            ...
            .stat-card, .quick-actions .col { margin-bottom: 1rem; } /* Spacing for stacked cards */
            .stat-card .value { font-size: 1.8rem; }
            .stat-card .icon-wrapper { font-size: 1.5rem; }
            .digital-clock { font-size: 2.5rem; }
            .calendar-grid .day { padding: 6px; font-size: 0.8rem; }
        }
