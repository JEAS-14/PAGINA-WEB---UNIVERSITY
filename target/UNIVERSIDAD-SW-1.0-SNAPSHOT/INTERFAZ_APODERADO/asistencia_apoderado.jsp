...
<%
    ...
    String ultimoAcceso = ""; // Se actualizará con la hora actual del servidor, no depende de la BD
    ...
    // Obtener el primer día del mes y el último día del mes para las consultas de rango
    ...
    List<String> fechasAsistenciaMes = new ArrayList<>(); // Fechas para el eje X del gráfico
        ...
        if (idApoderado != -1 && globalErrorMessage == null) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    System.out.println("DEBUG (asistencia_apoderado): Datos de apoderado cargados: " + nombreApoderado);
                } else {
                    globalErrorMessage = "Apoderado no encontrado en la base de datos. Por favor, contacte a soporte.";
                    System.err.println("ERROR (asistencia_apoderado): Apoderado con ID " + idApoderado + " no encontrado en BD.");
                }
            ...
            // --- 5. Obtener Registros de Asistencia del Hijo (si hay un hijo asignado y no hay errores previos) ---
            ...
            if (idHijo != -1 && globalErrorMessage == null) {
                try {
                    // Consulta para obtener el conteo de cada estado de asistencia por día
                    ...
                    pstmt.setInt(1, idHijo);
                    // Formatear LocalDate a String 'YYYY-MM-DD' para la consulta SQL
    ...
    // Formato para la fecha de "Último acceso" (no se usa en esta página, pero lo mantengo por consistencia)
    // LocalDateTime.now().format(DateTimeFormatter.ofPattern("EEEE, d 'de' MMMM 'de'yyyy, HH:mm", new Locale("es", "ES")));
%>
...
<head>
    ...
    <title>Asistencia de mi Hijo | Dashboard Apoderado | Sistema Universitario</title>
    ...
    <style>
        ...
        .badge.bg-info { background-color: var(--admin-info) !important; color: var(--admin-text-dark) !important;} /* Justificado badge text is dark */
        .badge.bg-secondary { background-color: var(--admin-secondary-color) !important; }

        /* Chart Container */
        .chart-container {
            height: 350px; /* Tamaño más pequeño para los gráficos */
            width: 100%;
            margin: auto;
            display: flex;
    ...
    <div id="app">
        <nav class="sidebar">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<%= request.getContextPath() %>/INTERFAZ_APODERADO/asistencia_apoderado.jsp"><i class="fas fa-clipboard-check"></i><span> Asistencia de mi hijo</span></a>
                </li>
                <li class="nav-item">
        ...
        <div class="main-content">
            ...
            <div class="container-fluid">
                <div class="welcome-section">
                    <h1 class="h3 mb-3"><i class="fas fa-clipboard-check me-2"></i>Historial de Asistencia de <%= nombreHijo %></h1>
                    <p class="lead">Aquí puede ver el historial de asistencia de su hijo/a a las clases inscritas.</p>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="mb-1"><strong>Registros de Asistencia:</strong> <%= asistenciaHijoList.size() %></p>
                            </div>
                        </div>
                        <% } else { %>
                ...
                <div class="card content-section mb-4">
                    <div class="card-header">
                        <h3 class="section-title mb-0"><i class="fas fa-chart-line me-2"></i>Asistencia Mensual de <%= nombreMesActual %></h3>
                    </div>
                    <div class="card-body">
                        <% 
                            ...
                            boolean hasAttendanceData = !fechasAsistenciaMes.isEmpty() || 
                                ...
                                justificadosPorDia.stream().anyMatch(val -> val > 0); // Incluir justificados
                        %>
                        ...
                        <% } else { %>
                            ...
                            <p class="text-muted text-center"><small>Asegúrate de que se haya registrado asistencia para su hijo/a.</small></p>
                        <% } %>
                    </div>
                </div>
                ...
                <div class="card content-section mb-4">
                    <div class="card-header">
                        <h3 class="section-title mb-0"><i class="fas fa-table me-2"></i>Detalle de Asistencia</h3>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <% } else { %>
                            <p class="text-muted text-center py-3">No hay registros de asistencia disponibles para su hijo/a actualmente.</p>
                            <% } %>
                        </div>
                    </div>
                </div>
